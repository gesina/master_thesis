...
\item The following notation for cup-~and cap-product will be used,
  ...
  \item The (relative) cap-product is denoted as
    \begin{align*}
      ...
      (x, \alpha) &\longmapsto x\cap \alpha
    \end{align*}
  \item If $X$ is an $n$-dimensional, $R$-orientable manifold define
    \begin{align*}
      \capped - -\colon
      H^i(X,A;R)\times H_{n-i}(X,A;R) &\longto H_n(X) \cong \Zmod2\\
      (x, \alpha) &\longmapsto \capped x \alpha \coloneqq x\cap \alpha
    \end{align*}
  \end{itemize}
\end{itemize}
