...
\item All vector bundles are real if not stated otherwise, and $0_\xi$
  denotes the zero section of a vector bundle $\xi\colon E\to B$ or
  its image,
  $E_b$ denotes the fiber at $b\in B$.
\end{itemize}
