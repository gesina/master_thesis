...
\begin{Rem}\label{rem:splitdim}
  ...
  \end{itemize}
\end{Rem}
Such splits as described above are favourable because the binomial
...
checked using results of Sanderson~\optcite{sanderson} which say that
...
\begin{Thm}\label{thm:brown}
  ...
  complete generating set of the cobodism ring, \idest
  \begin{gather*}
