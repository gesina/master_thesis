...
\end{Thm}
\begin{Rem}
  Theorem~\ref{thm:twistedprod:cohomstructure} says that, for a space
  $X$ and $k\in\Nat$, $\H^*(\Twistedprod k X)$ is the group
  \begin{align*}
    \H^*(\Twistedprod{k}{X})
    &\cong
  ...
  \end{enumerate}
\end{Rem}
\begin{proof}[proof of Theorem~\ref{thm:twistedprod:cohomstructure}]
