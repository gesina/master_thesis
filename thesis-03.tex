...
Recall that the Steenrod problem on realising homology classes by
...
\end{LemDef}
\begin{proof}[proof of
  Lemma~\itemref{lem:evengen}{lem:evengen:immersionprop}
  (immersion property)]
...
\end{proof}
\begin{proof}[proof of
  Lemma~\itemref{lem:evengen}{lem:evengen:indecomposable}
  (indecomposability)]
