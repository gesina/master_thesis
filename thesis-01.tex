...
\begin{itemize} % TODO: Chapter overview
\item Stuff necessary for formulation:
  \begin{itemize}
  \item Introduce immersions and the normal bundle
    (will be connected for homotopy theoretical investigation in Chap 2)
  \item Introduce Steenrod squares, Thom classes, Thom isos
  \item Introduce concept of characteristic classes
  \item Introduce SW classes with major properties
  \item Show SW classes are combi of the above
    (needed for Wu's resp. Massey's Theorem)
  \item Later: Further char. classes 
  \end{itemize}
\item formulate
\item reformulate
\item connection to characteristic classes
\end{itemize}

\section{Immersions and Normal Bundles}
% TODO: section overview
Immersions are merely a special case of monomorphisms of vector
bundles. So, recall that a morphism
...
Another major property of immersions which will finally make it
possible to translate the existence of an immersion into a homotopy
theoretical statement, is that every immersion gives rise to a normal
bundle as follows.
\begin{LemDef}
  ...
  \item
    ...
    $\N{\imm_2}$ factors over the classifying map $f_1$ of
    $\N{\imm_1}$ as   
    \begin{center}
      \begin{tikzcd}
        M \ar[r, "f_1"]
...
\begin{LemDef}[Classifying Spaces]\label{def:charcls}
...
\begin{Rem} % TODO: Why are char classes nice idea?
\end{Rem}
...
\section{Reformulation of the Immersion Problem}
% TODO: section overview
...
\end{Thm}
% TODO: Def "immersion problem", "immersion property" of a manifold
...
% TODO: Obstruction by Stiefel-Whitney classes
