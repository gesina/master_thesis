...
\begin{Def}[Steenrod Squares]\label{def:sq} % TODO: Check
...
\begin{Lem}\label{thomisoself-adjoint}
  ...
  \begin{proof}
    ...
    \begin{align*}
      ...
      &\equalsby{\eqref{capprod1}}
        \capped{\pb p x}{\U\cap\alpha} \\
      &\equalsby{\eqref{capprod3}}
        \pf p\capped{\pb p x}{\U\cap\alpha} \\
      &\equalsby{\eqref{capprod2}}
  ...
  \begin{proof}
    ...
    \item[Multiplicativity:] % TODO: Multiplicativity alt def SW-classes
      ...
      \begin{align*}
        ...
        &= \Sq i(\u{\xi\oplus\eta}) \\
        &\equalsby{\autoref{thomclassmultiplicative}}
        ...
        &\equalsby{\eqref{projectionscommute}, Definition}
          \left(\sum_{r+s=i}
          \pb p_{\xi\oplus\eta} \w{r}{\xi} \cup \pb p_{\xi\oplus\eta} \w{s}{\eta}
          \right)
          \cup
          \u{\xi} \times \u{\eta} \\
        &\equalsby{Group Hom., \ref{thomclassmultiplicative}}
          \pb p_{\xi\oplus\eta}
...
\begin{Thm}\label{altdefwuclasses}
  ...
  \begin{proof}
    ...
    \begin{align*}
      \capped{x\cup \vu}{\fundcl M}
      &\cequalsby{\eqref{proofaltdefwuclasses:eq1}}
        \capped
        {\SQ\left(\thomiso\left(x\cup\vu\right)\right)}
        {\pf\collapse\fundcl{\Sph}}
      \\
      &\cequalsby{\eqref{proofaltdefwuclasses:eq2}}
        \capped
        {\thomiso(\SQ(x))}
        {\pf\collapse\fundcl{\Sph}}
      \\
...
\end{proof}
\begin{proof}[proof of Lemma~\autoref{wulemma}]
