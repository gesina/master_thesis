...
liftings up to homotopy, and to outline how characteristic 
...
of further structure to a cohomology ring, adding more tools to
...
of Stiefel-Whitney classes, especially a construction using Thom classes.
...
\subsection{Thom Classes}\label{sec:thomclasses}
...
\emph{no} characteristic classes as defined before. However, the tools
that will be introduced in this section are an important ingredient in
...
\subsection{Stiefel-Whitney Classes}\label{sec:swclasses}
