...
\newcommand*{\dualWs}{\dual{\mathrm{w}}} % dual Stiefel-Whitney class symbol
...
\newcommand*{\W}[1]{\w{}{#1}} % total Stiefel-Whitney class of bdl
\newcommand*{\dualW}[1]{\dualw{}{#1}} % total dual Stiefel-Whitney class of bdl

\newcommand*{\vu}{v} % Wu class symbol
\newcommand*{\dualvu}{\dual{\vu}} % total Wu class without argument
\renewcommand*{\v}[2]{\charcl{\vu_{#1}}{#2}} % {#1}th Wu class of mfd/bdl (overwrites check over letter)
\newcommand*{\dualv}[2]{\charcl{\dualvu_{#1}}{#2}} % {#1}th dual Wu class of mfd/bdl
\newcommand*{\V}[1]{\v{}{#1}} % total Wu class of a mfd/bdl
\newcommand*{\dualV}[1]{\dualv{}{#1}} % dual total Wu class of mfd/bdl
