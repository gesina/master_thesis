...
\chapter{Brown's Theorem}\label{chap:brown}
...
\begin{Thm}\label{thm:basiscobordismring}
  ...
  \begin{proof}
    ...
    % TODO: (GEORGE) proof/construction special basis cobordism ring [Thom]? [Milnor] better source?
  \end{proof}
\end{Thm}
...
\begin{Thm}\label{thm:twistedprod:cohomstructure}
  ...
  \begin{proof}
    ...
    % TODO: (GEORGE) Either proof or explicitly say somewhere that the proof is missing
  \end{proof}
\end{Thm}
